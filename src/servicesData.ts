...
export const orgoServices: Category[] = [
  {
    ...
    icon: 'droplets',
    priceStart: 199,
    imageUrl: 'https://images.unsplash.com/photo-1542013936693-884638332954?q=80&w=774&auto=format&fit=crop',
    category: 'Home',
    color: 'blue',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'wind',
    priceStart: 499,
    imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?q=80&w=823&auto=format&fit=crop',
    category: 'Appliances',
    color: 'cyan',
    tag: 'Trending',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'brush',
    priceStart: 399,
    imageUrl: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=870&auto=format&fit=crop',
    category: 'Home',
    color: 'emerald',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'zap',
    priceStart: 99,
    imageUrl: 'https://images.unsplash.com/photo-1674659719067-8735479ba10c?q=80&w=870&auto=format&fit=crop',
    category: 'Home',
    color: 'amber',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'flower',
    priceStart: 299,
    imageUrl: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=870&auto=format&fit=crop',
    category: 'Home',
    color: 'green',
    subCategories: [
...

  {
    ...
    icon: 'car',
    priceStart: 199,
    imageUrl: 'https://images.unsplash.com/photo-1625047509168-a7026f36de04?q=80&w=880&auto=format&fit=crop',
    category: 'Vehicle',
    color: 'red',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'bug',
    priceStart: 599,
    imageUrl: 'https://images.unsplash.com/photo-1747659629851-a92bd71149f6?q=80&w=870&auto=format&fit=crop',
    category: 'Home',
    color: 'purple',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'hammer',
    priceStart: 199,
    imageUrl: 'https://images.unsplash.com/photo-1659930087003-2d64e33181f7?q=80&w=870&auto=format&fit=crop',
    category: 'Home',
    color: 'orange',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'shield',
    priceStart: 999,
    imageUrl: 'https://images.unsplash.com/photo-1589935447067-5531094415d1?q=80&w=870&auto=format&fit=crop',
    category: 'Home',
    color: 'slate',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'package',
    priceStart: 1999,
    imageUrl: 'https://images.unsplash.com/photo-1609143739217-01b60dad1c67?q=80&w=774&auto=format&fit=crop',
    category: 'Home',
    color: 'indigo',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'wrench',
    priceStart: 499,
    imageUrl: 'https://images.unsplash.com/photo-1543525324-26e03b510586?q=80&w=774&auto=format&fit=crop',
    category: 'Home',
    color: 'stone',
    subCategories: [
  ...
  },
  {
    ...
    icon: 'wrench',
    priceStart: 299,
    imageUrl: 'https://images.unsplash.com/photo-1721613877687-c9099b698faa?q=80&w=870&auto=format&fit=crop',
    category: 'Appliances',
    color: 'orange',
    subCategories: [
      {
        ...
        items: [
          ...
          ...['Not Starting', 'Not Spinning/Drying', 'Water Not Filling', 'Water Not Draining', 'Excessive Vibration', 'Door Lock Problem', 'Drum Noise', 'PCB/Display Issue', 'Leakage', 'Bad Smell', 'Installation/Uninstallation'].map(issue => ({
            ...
            imageUrl: 'https://images.unsplash.com/photo-1723259461381-59ab9fa18f5d?q=80&w=735&auto=format&fit=crop'
          })),
          // Refrigerator
          ...
          ...['No Display/Black Screen', 'No Sound', 'Screen Lines', 'Panel Damage', 'Remote Not Working', 'HDMI Port Not Working', 'Smart TV Software', 'TV Not Powering On', 'Wall Mount'].map(issue => ({
            ...
            imageUrl: 'https://images.unsplash.com/photo-1567690187548-f07b1d7bf5a9?q=80&w=736&auto=format&fit=crop'
          }))
        ]
      },
      {
        ...
        icon: 'coffee',
        imageUrl: 'https://images.unsplash.com/photo-1642979430180-e676c2235ce2?q=80&w=1032&auto=format&fit=crop',
        items: [
          // Microwave
          ...
          ...['Gas Leakage', 'Burner Not Igniting', 'Low Flame', 'Knob Not Working', 'Auto Ignition Failure', 'Pipe Installation'].map(issue => ({
            ...
            imageUrl: 'https://images.unsplash.com/photo-1609211373254-b52e03ba0c85?q=80&w=776&auto=format&fit=crop'
          })),
          // Laptop
          ...['Not Turning On', 'Battery Not Charging', 'Screen Damage', 'Keyboard Not Working', 'Overheating', 'Slow Performance', 'OS/Software', 'Motherboard', 'Speaker/Sound'].map(issue => ({
            ...
            imageUrl: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?q=80&w=871&auto=format&fit=crop'
          })),
          // Geyser
          ...['Not Heating', 'Water Leakage', 'Power Issue', 'Thermostat', 'Rusty Water', 'Installation'].map(issue => ({
            ...
            imageUrl: 'https://images.unsplash.com/photo-1714894691666-e8bb020c781c?q=80&w=774&auto=format&fit=crop'
          })),
          // RO Purifier
          ...['RO Service', 'RO Repair', 'Filter Replacement', 'Installation', 'Uninstallation', 'Water Quality Check'].map(issue => ({
            ...
            imageUrl: 'https://images.unsplash.com/photo-1662460149789-5aebed905701?q=80&w=774&auto=format&fit=crop'
          }))
        ]
      }
    ]
